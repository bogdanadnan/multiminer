...
private:
    ...
    static void digestLongSameSalt(void *out, std::size_t outLen,
                           const void *in, std::size_t inLen);

    void initialHash(void *out, const void *pwd, std::size_t pwdLen,
                     Type type, Version version) const;

    void initialHashSameSalt(void *out, const void *pwd, std::size_t pwdLen,
                     Type type, Version version) const;
...
public:
    ...
    void fillFirstBlocksSameSalt(void *memory, const void *pwd, std::size_t pwdLen,
                         Type type, Version version) const;
